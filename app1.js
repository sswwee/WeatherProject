...
app.post("/", function(req, res){ //caching data using post
    ...
    const query = req.body.zipCode;  //getting Dynamic data  //zipCode is from index.html
    const countryCode = req.body.countryCode;
    const apiKey = "775d0040b41db3597de8b605a53c46f0";
    const unit = "imperial";

    const url = "https://api.openweathermap.org/data/2.5/weather?zip=" + query + "," + countryCode + "&appid=" + apiKey + "&units=" + unit;
    https.get(url, function(response){
        ...
        response.on("data", function(data){
            ...
            res.write("<h1>The temperature in " + query + " is " + temp + " degree Farenheit</h1>"); 
